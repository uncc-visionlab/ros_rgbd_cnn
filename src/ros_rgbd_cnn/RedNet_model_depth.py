...
class RedNet(nn.Module):
    ...
    def forward_downsample(self, depth):
    ...
    def forward_upsample(self, fuse0, fuse1, fuse2, fuse3, fuse4):
        ...
        #print("x size = ", x.size())
        #print("self.agent3 size =", self.agant3(fuse3).size())
